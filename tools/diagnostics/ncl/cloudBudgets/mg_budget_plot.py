...
if budget == 'mass':
   if state == 'cldliq':
      if mg10:
         if diff:
            plottitle = 'Liquid mass budget NorESM MG1.0 PD-PI'
         else:
            plottitle = 'Liquid mass budget NorESM MG1.0 PD'
      else:
         if diff:
            plottitle = 'Liquid mass budget NorESM MG1.5 PD-PI'
         else:
            plottitle = 'Liquid mass budget NorESM MG1.5 PD'

   elif state == 'cldice':
      if mg10:
         if diff:
            plottitle = 'Ice mass budget NorESM MG1.0 PD-PI'
         else:
            plottitle = 'Ice mass budget NorESM MG1.0 PD'
      else:
         if diff:
            plottitle = 'Ice mass budget NorESM MG1.5 PD-PI'
         else:
            plottitle = 'Ice mass budget NorESM MG1.5 PD'

elif budget == 'number':
   if state == 'cldliq':
      if mg10:
         if diff:
            plottitle = 'Liquid number budget NorESM MG1.0 PD-PI'
         else:
            plottitle = 'Liquid number budget NorESM MG1.0 PD'
      else:
         if diff:
            plottitle = 'Liquid number budget NorESM MG1.5 PD-PI'
         else:
            plottitle = 'Liquid number budget NorESM MG1.5 PD'
 
   elif state == 'cldice':
      if mg10:
         if diff:
            plottitle = 'Ice number budget NorESM MG1.0 PD-PI'
         else:
            plottitle = 'Ice number budget NorESM MG1.0 PD'
      else:
         if diff:
            plottitle = 'Ice number budget NorESM MG1.5 PD-PI'
         else:
            plottitle = 'Ice number budget NorESM MG1.5 PD'
...
# Read netcdf file
if mg10:
   # Give path to your file here if you used MG1.0
   id_nc = netCDF4.Dataset('path/to/your/file/MG1.0.nc','r')
   if diff:
      # Give path to your file you want to compare with here if you used MG1.0
      # Will compare id_nc-id_nc2
      id_nc2 = netCDF4.Dataset('path/to/your/file/MG1.0.nc','r')
else:
   # Give path to your file here if you used MG1.5
   id_nc = netCDF4.Dataset('path/to/your/file/MG1.5.nc','r')
   if diff:
      # Give path to your file you want to compare with here if you used MG1.5
      # Will compare id_nc-id_nc2
      id_nc2 = netCDF4.Dataset('path/to/your/file/MG1.5.nc','r')
...
if budget == 'number':
   ...
   # In both cloud liquid and ice states:
