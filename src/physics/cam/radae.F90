...
subroutine radae_init( &
   gravx, epsilox, stebol, pstdx, mwdryx, &
   mwco2x, mwo3x, absems_data)
!
...
!
   ...
   character(len=*) :: absems_data ! full pathname for time-invariant absorption dataset
