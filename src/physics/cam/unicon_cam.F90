...
subroutine unicon_cam_init(pbuf2d)
   ...
   !f  call addfld('exit_Cu_SP', horiz_only, 'A', '1', 'Exit identifier of UNICON')
   ...
   !d  call addfld('orgforce_SP', horiz_only, 'A', 'kg/m/s^2', 'Various organization forcing of UNICON')
   !d  call addfld('tau_org_SP',        horiz_only, 'A',  's', 'Damping time scale of convective organization of UNICON')
   !d  call addfld('tau_TKE_SP',        horiz_only, 'A',  's', 'Damping time scale of meso-scale TKE of UNICON')
   ...
   !a  call addfld('CFL_SP', (/ 'lev' /), 'A', '1', 'Numerical stability parameter of UNICON')
   ...
   do msfc = 1, nseg
      ...
      ! call addfld('ktop'//numcha//'_SP', horiz_only, 'A', '1', numcha//' updraft segment : top layer index')
...
subroutine unicon_cam_tend(dt, state, cam_in, &
                           pbuf, ptend, out)
