...
!---------------------------Local storage-------------------------------
    ...
    real(r8) :: delTpDelZ1(pcols)                       ! Top level of partial derivative of Tp with z
...
!    cBF = 1._r8
	...
	!-------------------------------------------------------------
	if (iVer == 1) delTpDelZ1(icol) = delTpDelZ	 
    ...
    do iCol = 1, ncol
      ...
      c43r = ( 2._r8 * delTpDelZ1(icol) + rMassOp / avogad * gravit / kboltz * .01_r8 )/2._r8/tP(iCol,1)
      c41 = c31 * c43r
