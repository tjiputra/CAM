...
! ----- INTERNAL -----    
  ...
  e_comp = cmplx(e_r,e_i,kind=kind(0d0))  !+JEK
  sq = sqrt(e_comp)
...
!     ACCELERATOR VARIABLES
      ...
      End Do
      Do I =1,Inp2
         Sm(I) = cmplx(0,0,kind=kind(0d0)) !+JEK
         Sp(I) = cmplx(0,0,kind=kind(0d0)) !+JEK
         Pi0(I) = 0
         Pi1(I) = 1
      End Do
      Psi0 = Cos(Dx)
      ...
      APsi0 = Psi0
      APsi1 = Psi1
      Xi0 = cmplx(APsi0,Chi0,kind=kind(0d0)) !+JEK
      Xi1 = cmplx(APsi1,Chi1,kind=kind(0d0)) !+JEK
      Dg = 0
      Dqsc = 0
      Dqxt = 0
      Tnp1 = 1
      Do N = 1,Nstop
         ...
         Xi = cmplx(APsi,Chi,kind=kind(0d0)) !+JEK
