...
!
    ...
    character(len=*), parameter :: subname='READ_INIDAT'   ! subroutine name
!
!-----------------------------------------------------------------------
...
!
    ...
    do m = 1,pcnst
       ...
       if(cnst_read_iv(m)) &
            call cam_pio_get_var(fieldname, fh_ini, arraydims3, arr3d_a, found=readvar)
       call process_inidat_pio('CONSTS', m_cnst=m, fh=fh_ini)
...
!*********************************************************************
  ...
  subroutine process_inidat_pio(fieldname, m_cnst, fh)
!
!-----------------------------------------------------------------------
!
! Purpose:
