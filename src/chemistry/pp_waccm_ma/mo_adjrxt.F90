...
!--------------------------------------------------------------------
      ...
      rate(:,:, 87) = rate(:,:, 87) * inv(:,:, 1)
      rate(:,:, 89) = rate(:,:, 89) * inv(:,:, 1)
      rate(:,:, 92) = rate(:,:, 92) * inv(:,:, 2)
      rate(:,:, 98) = rate(:,:, 98) * inv(:,:, 2)
      rate(:,:,100) = rate(:,:,100) * inv(:,:, 2)
      rate(:,:,131) = rate(:,:,131) * inv(:,:, 1)
      rate(:,:,140) = rate(:,:,140) * inv(:,:, 1)
      rate(:,:,156) = rate(:,:,156) * inv(:,:, 1)
      rate(:,:,160) = rate(:,:,160) * inv(:,:, 1)
      ...
      rate(:,:,263) = rate(:,:,263) * inv(:,:, 2)
      rate(:,:,273) = rate(:,:,273) * inv(:,:, 2)
      rate(:,:,277) = rate(:,:,277) * inv(:,:, 2)
      rate(:,:,278) = rate(:,:,278) * inv(:,:, 2)
      rate(:,:,284) = rate(:,:,284) * inv(:,:, 2)
      rate(:,:, 87) = rate(:,:, 87) * m(:,:)
      rate(:,:, 88) = rate(:,:, 88) * m(:,:)
      rate(:,:, 89) = rate(:,:, 89) * m(:,:)
      rate(:,:, 90) = rate(:,:, 90) * m(:,:)
