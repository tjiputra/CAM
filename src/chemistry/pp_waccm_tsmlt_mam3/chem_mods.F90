...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 117, & ! number of photolysis reactions
                            rxntot = 449, & ! number of total reactions
                            gascnt = 332, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 158, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1509, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 135, & ! number of species in implicit class
