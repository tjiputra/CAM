...
!----------------------------------------------
         ...
         mat(1016) = -(rxt(119)*y(2) + rxt(137)*y(157) + rxt(164)*y(19) + rxt(169) &
                      *y(129) + rxt(177)*y(130) + rxt(192)*y(6) + rxt(195)*y(7) &
                      + rxt(207)*y(127) + rxt(234)*y(128) + rxt(293)*y(37) + rxt(314) &
         ...
         mat(1016) = mat(1016) + .100_r8*rxt(360)*y(65) + .200_r8*rxt(336)*y(60) &
                      + .200_r8*rxt(342)*y(61)
         ...
         mat(943) = -(rxt(118)*y(3) + rxt(119)*y(1) + 4._r8*rxt(120)*y(2) + rxt(168) &
                      *y(129) + rxt(175)*y(18) + rxt(176)*y(130) + rxt(179)*y(20) &
         ...
         mat(904) = mat(904) + (rxt(132)+rxt(133))*y(157) + rxt(185)*y(5) + rxt(443) &
                      *y(150) + rxt(435)*y(151) + rxt(404)*y(107) + rxt(407)*y(108)
         ...
         mat(970) = -((rxt(132) + rxt(133)) * y(3) + rxt(134)*y(158) + rxt(137)*y(1) &
         ...
         mat(903) = -(rxt(118)*y(2) + rxt(128)*y(156) + rxt(132)*y(157) + rxt(163) &
                      *y(19) + rxt(182)*y(154) + rxt(185)*y(5) + rxt(291)*y(135) &
                      + rxt(404)*y(107) + rxt(407)*y(108) + rxt(435)*y(151) + (rxt(442) &
                      + rxt(443)) * y(150) + rxt(445)*y(148))
         mat(942) = -rxt(118)*y(3)
         mat(51) = -rxt(128)*y(3)
         mat(968) = -rxt(132)*y(3)
         ...
         mat(1013) = 2.000_r8*rxt(119)*y(2) + 2.000_r8*rxt(137)*y(157) + rxt(192)*y(6) &
                      + rxt(195)*y(7) + rxt(169)*y(129) + rxt(164)*y(19) &
                      + 2.000_r8*rxt(177)*y(130) + rxt(207)*y(127) + rxt(234)*y(128) &
                      + rxt(405)*y(107) + rxt(408)*y(108)
         mat(942) = mat(942) + 2.000_r8*rxt(119)*y(1) + 2.000_r8*rxt(120)*y(2) &
                      + rxt(127)*y(156) + rxt(193)*y(7) + rxt(168)*y(129) + rxt(201) &
                      *y(8) + rxt(176)*y(130) + rxt(214)*y(24) + rxt(237)*y(31)
         ...
         mat(1378) = rxt(169)*y(1) + rxt(168)*y(2) + rxt(205)*y(10) + rxt(170)*y(130) &
                      + rxt(216)*y(24)
         mat(1422) = rxt(201)*y(2) + rxt(203)*y(130)
         mat(216) = rxt(205)*y(129)
         mat(873) = rxt(274)*y(130)
         mat(1164) = mat(1164) + rxt(164)*y(1) + rxt(166)*y(130)
         mat(1109) = 2.000_r8*rxt(177)*y(1) + rxt(176)*y(2) + rxt(170)*y(129) &
                      + rxt(203)*y(8) + rxt(274)*y(13) + rxt(166)*y(19) &
                      + 2.000_r8*rxt(178)*y(130) + rxt(210)*y(127) + rxt(217)*y(24) &
                      + rxt(235)*y(128) + rxt(239)*y(31) + rxt(322)*y(137) &
                      + .750_r8*rxt(352)*y(141) + rxt(296)*y(132) + rxt(317)*y(136) &
                      + rxt(326)*y(138)
         mat(1144) = rxt(207)*y(1) + rxt(210)*y(130)
         mat(1040) = rxt(214)*y(2) + rxt(216)*y(129) + rxt(217)*y(130) + ( &
                      + 2.000_r8*rxt(221)+2.000_r8*rxt(222))*y(24) + (rxt(243) &
                       +rxt(244))*y(31)
         mat(840) = rxt(234)*y(1) + rxt(235)*y(130)
         mat(1188) = rxt(237)*y(2) + rxt(239)*y(130) + (rxt(243)+rxt(244))*y(24) &
         ...
         mat(650) = -(rxt(159)*y(157) + rxt(173)*y(129) + rxt(175)*y(2) + rxt(208) &
                      *y(127) + rxt(251)*y(103))
         ...
         mat(998) = .560_r8*rxt(314)*y(48) + .300_r8*rxt(360)*y(65) + .500_r8*rxt(293) &
                      *y(37) + .050_r8*rxt(336)*y(60) + .200_r8*rxt(342)*y(61)
         mat(936) = rxt(271)*y(16) + rxt(401)*y(106)
         mat(1229) = .220_r8*rxt(343)*y(142) + .500_r8*rxt(378)*y(145)
         mat(1361) = mat(1361) + rxt(270)*y(16) + rxt(309)*y(44) + rxt(330)*y(54) &
                      + .350_r8*rxt(286)*y(98) + rxt(402)*y(106)
         mat(1407) = rxt(269)*y(16) + .220_r8*rxt(345)*y(142) + rxt(331)*y(54) &
                      + .500_r8*rxt(379)*y(145)
         mat(860) = .110_r8*rxt(347)*y(142) + .200_r8*rxt(381)*y(145)
         mat(1489) = rxt(271)*y(2) + rxt(270)*y(129) + rxt(269)*y(8) + rxt(212)*y(127) &
                      + rxt(236)*y(128)
         ...
         mat(717) = .220_r8*rxt(343)*y(6) + .220_r8*rxt(345)*y(8) + .110_r8*rxt(347) &
                      *y(13) + .220_r8*rxt(348)*y(133)
         mat(661) = rxt(330)*y(129) + rxt(331)*y(8)
         mat(674) = .500_r8*rxt(378)*y(6) + .500_r8*rxt(379)*y(8) + .200_r8*rxt(381) &
                      *y(13) + .500_r8*rxt(382)*y(133)
         mat(93) = .350_r8*rxt(286)*y(129)
         mat(145) = rxt(401)*y(2) + rxt(402)*y(129)

         mat(476) = -(rxt(184)*y(129) + rxt(185)*y(3) + rxt(186)*y(6) + (rxt(187) &
                      + rxt(188) + rxt(189)) * y(7) + rxt(440)*y(149))
...
!----------------------------------------------
         ...
         mat(1252) = -(rxt(186)*y(5) + rxt(190)*y(2) + rxt(191)*y(130) + rxt(192)*y(1) &
                      + rxt(200)*y(8) + rxt(219)*y(24) + rxt(240)*y(31) + rxt(273) &
                      *y(13) + rxt(281)*y(131) + rxt(289)*y(134) + rxt(295)*y(132) &
                      + rxt(302)*y(133) + rxt(316)*y(136) + rxt(321)*y(137) + rxt(325) &
                      *y(138) + rxt(334)*y(139) + rxt(338)*y(140) + (rxt(343) + rxt(344) &
                      ) * y(142) + rxt(350)*y(141) + rxt(362)*y(144) + rxt(368)*y(69) &
                      + rxt(375)*y(143) + rxt(378)*y(145) + rxt(386)*y(146) + rxt(394) &
                      *y(147) + rxt(441)*y(149))
         mat(482) = -rxt(186)*y(6)
         mat(951) = -rxt(190)*y(6)
         ...
         mat(482) = mat(482) + rxt(185)*y(3) + 2.000_r8*rxt(188)*y(7) + rxt(184) &
                      *y(129)
         ...
         mat(1290) = -((rxt(187) + rxt(188) + rxt(189)) * y(5) + (rxt(193) + rxt(194) &
                      ) * y(2) + rxt(195)*y(1) + rxt(196)*y(8) + rxt(198)*y(129) &
                      + rxt(204)*y(130) + rxt(220)*y(24) + rxt(241)*y(31) + rxt(303) &
                      *y(133) + rxt(356)*y(141) + rxt(390)*y(76) + rxt(409)*y(108))
         ...
         mat(1253) = rxt(192)*y(1) + rxt(190)*y(2) + 2.000_r8*rxt(200)*y(8) + rxt(273) &
                      *y(13) + rxt(191)*y(130) + rxt(219)*y(24) + rxt(240)*y(31) &
                      + rxt(321)*y(137) + rxt(302)*y(133) + rxt(334)*y(139) &
                      + .900_r8*rxt(375)*y(143) + rxt(338)*y(140) + .900_r8*rxt(386) &
                      *y(146) + rxt(394)*y(147) + .920_r8*rxt(362)*y(144) + rxt(343) &
                      *y(142) + rxt(350)*y(141) + rxt(295)*y(132) + rxt(316)*y(136) &
                      + rxt(289)*y(134) + rxt(325)*y(138) + 1.206_r8*rxt(368)*y(69) &
                      + rxt(378)*y(145) + rxt(281)*y(131)
         mat(1290) = mat(1290) + .700_r8*rxt(390)*y(76)
         mat(1388) = mat(1388) + rxt(202)*y(8) + rxt(205)*y(10) + rxt(332)*y(64) &
                      + .400_r8*rxt(372)*y(70)
         mat(1432) = mat(1432) + rxt(201)*y(2) + 2.000_r8*rxt(200)*y(6) + rxt(202) &
                      *y(129) + rxt(203)*y(130) + rxt(363)*y(144) + rxt(345)*y(142) &
                      + rxt(351)*y(141) + rxt(393)*y(77) + 1.206_r8*rxt(369)*y(69) &
                      + rxt(373)*y(70) + rxt(379)*y(145)
         mat(218) = rxt(205)*y(129)
         mat(880) = rxt(273)*y(6)
         mat(1119) = mat(1119) + rxt(191)*y(6) + rxt(203)*y(8) + .206_r8*rxt(370) &
                      *y(69)
         ...
         mat(393) = rxt(289)*y(6)
         mat(632) = rxt(325)*y(6)
         mat(579) = 1.206_r8*rxt(368)*y(6) + 1.206_r8*rxt(369)*y(8) + .206_r8*rxt(370) &
                      *y(130)
         mat(534) = .400_r8*rxt(372)*y(129) + rxt(373)*y(8)
         mat(683) = rxt(378)*y(6) + rxt(379)*y(8)
         mat(182) = rxt(281)*y(6)

         mat(1389) = -(rxt(168)*y(2) + rxt(169)*y(1) + rxt(170)*y(130) + (4._r8*rxt(171) &
                      + 4._r8*rxt(172)) * y(129) + rxt(173)*y(18) + rxt(174)*y(20) &
         ...
         mat(1024) = mat(1024) + rxt(164)*y(19) + rxt(177)*y(130) + .330_r8*rxt(314) &
                      *y(48) + .270_r8*rxt(360)*y(65) + .120_r8*rxt(293)*y(37) &
                      + .080_r8*rxt(336)*y(60) + .215_r8*rxt(342)*y(61) &
                      + .700_r8*rxt(392)*y(77)
         mat(953) = mat(953) + rxt(175)*y(18) + rxt(271)*y(16) + rxt(176)*y(130) &
                      + rxt(179)*y(20) + rxt(227)*y(27) + rxt(228)*y(28) + rxt(247) &
                      *y(32) + rxt(248)*y(33)
         mat(979) = rxt(159)*y(18) + rxt(162)*y(35) + 2.000_r8*rxt(134)*y(158) &
                      + rxt(160)*y(27) + rxt(161)*y(32)
         mat(657) = mat(657) + rxt(175)*y(2) + rxt(159)*y(157)
         mat(1254) = rxt(191)*y(130)
         mat(1389) = mat(1389) + .300_r8*rxt(278)*y(14) + .500_r8*rxt(323)*y(52) &
         ...
         mat(1120) = mat(1120) + rxt(177)*y(1) + rxt(176)*y(2) + rxt(191)*y(6) &
                      + rxt(203)*y(8) + 2.000_r8*rxt(165)*y(19) + rxt(211)*y(127)
...
!----------------------------------------------
         ...
         mat(1434) = -(rxt(196)*y(7) + rxt(200)*y(6) + rxt(201)*y(2) + rxt(202)*y(129) &
                      + rxt(203)*y(130) + rxt(269)*y(16) + rxt(301)*y(41) + rxt(315) &
                      *y(48) + rxt(331)*y(54) + rxt(345)*y(142) + rxt(351)*y(141) &
                      + rxt(361)*y(65) + rxt(363)*y(144) + rxt(369)*y(69) + rxt(373) &
         ...
         mat(1390) = mat(1390) + rxt(199)*y(9) + rxt(232)*y(29) + rxt(312)*y(47) &
                      + .500_r8*rxt(358)*y(63)
         ...
         mat(1435) = rxt(269)*y(16) + rxt(301)*y(41) + rxt(331)*y(54) + rxt(417) &
                      *y(105)
         ...
         mat(872) = -(rxt(218)*y(24) + rxt(273)*y(6) + rxt(274)*y(130) + (4._r8*rxt(275) &
                      + 4._r8*rxt(276)) * y(13) + rxt(297)*y(132) + rxt(305)*y(133) &
                      + rxt(318)*y(136) + rxt(327)*y(138) + rxt(347)*y(142) + rxt(353) &
                      *y(141) + rxt(366)*y(144) + rxt(381)*y(145))
         ...
         mat(790) = mat(790) + rxt(302)*y(6) + .900_r8*rxt(305)*y(13) &
                      + 4.000_r8*rxt(306)*y(133) + rxt(367)*y(144) + rxt(348)*y(142) &
                      + rxt(354)*y(141) + rxt(382)*y(145)
         ...
         mat(1509) = -(rxt(212)*y(127) + rxt(236)*y(128) + rxt(269)*y(8) + rxt(270) &
                      *y(129) + rxt(271)*y(2) + rxt(272)*y(130))
         ...
         mat(1028) = .540_r8*rxt(314)*y(48) + .600_r8*rxt(360)*y(65) + rxt(293)*y(37) &
                      + .800_r8*rxt(336)*y(60) + .700_r8*rxt(342)*y(61)
         mat(1258) = rxt(273)*y(13) + rxt(321)*y(137) + .500_r8*rxt(334)*y(139) &
                      + .100_r8*rxt(375)*y(143) + .510_r8*rxt(362)*y(144) &
                      + .250_r8*rxt(343)*y(142) + rxt(350)*y(141) + .500_r8*rxt(289) &
                      *y(134) + rxt(325)*y(138) + .072_r8*rxt(368)*y(69)
         mat(1393) = mat(1393) + .300_r8*rxt(278)*y(14) + .500_r8*rxt(307)*y(45) &
                      + rxt(312)*y(47) + .500_r8*rxt(358)*y(63) + rxt(277)*y(15) &
                      + .800_r8*rxt(308)*y(43)
         mat(1437) = mat(1437) + .600_r8*rxt(363)*y(144) + .250_r8*rxt(345)*y(142) &
                      + rxt(351)*y(141) + .072_r8*rxt(369)*y(69)
         mat(885) = rxt(273)*y(6) + (4.000_r8*rxt(275)+2.000_r8*rxt(276))*y(13) &
                      + rxt(218)*y(24) + rxt(305)*y(133) + 1.200_r8*rxt(366)*y(144) &
                      + .880_r8*rxt(347)*y(142) + 2.000_r8*rxt(353)*y(141) &
                      + .700_r8*rxt(297)*y(132) + rxt(318)*y(136) + .800_r8*rxt(327) &
                      *y(138) + .700_r8*rxt(381)*y(145)
         ...
         mat(451) = rxt(321)*y(6)
         mat(801) = rxt(305)*y(13) + .600_r8*rxt(367)*y(144) + .250_r8*rxt(348)*y(142) &
                      + rxt(354)*y(141)
         ...
         mat(712) = .510_r8*rxt(362)*y(6) + .600_r8*rxt(363)*y(8) + 1.200_r8*rxt(366) &
                      *y(13) + .600_r8*rxt(367)*y(133)
         mat(754) = .800_r8*rxt(336)*y(1)
         mat(647) = .700_r8*rxt(342)*y(1)
         mat(733) = .250_r8*rxt(343)*y(6) + .250_r8*rxt(345)*y(8) + .880_r8*rxt(347) &
                      *y(13) + .250_r8*rxt(348)*y(133)
         mat(773) = rxt(350)*y(6) + rxt(351)*y(8) + 2.000_r8*rxt(353)*y(13) + rxt(354) &
                      *y(133) + 4.000_r8*rxt(355)*y(141)
         ...
         mat(583) = .072_r8*rxt(368)*y(6) + .072_r8*rxt(369)*y(8) + .008_r8*rxt(370) &
                      *y(130)
         mat(688) = .700_r8*rxt(381)*y(13)

         mat(1171) = -(rxt(163)*y(3) + rxt(164)*y(1) + (rxt(165) + rxt(166) + rxt(167) &
                      ) * y(130))
         ...
         mat(656) = rxt(175)*y(2) + rxt(159)*y(157) + rxt(173)*y(129) + rxt(208) &
                      *y(127) + rxt(251)*y(103)
         mat(604) = rxt(267)*y(129)
         mat(481) = rxt(184)*y(129)
         mat(1385) = rxt(168)*y(2) + rxt(173)*y(18) + rxt(267)*y(17) + rxt(184)*y(5) &
         ...
         mat(1114) = -((rxt(165) + rxt(166) + rxt(167)) * y(19) + rxt(170)*y(129) &
                      + rxt(176)*y(2) + rxt(177)*y(1) + 4._r8*rxt(178)*y(130) + rxt(191) &
                      *y(6) + rxt(203)*y(8) + rxt(204)*y(7) + (rxt(210) + rxt(211) &
                      ) * y(127) + rxt(217)*y(24) + rxt(235)*y(128) + rxt(239)*y(31) &
                      + rxt(272)*y(16) + rxt(274)*y(13) + rxt(282)*y(131) + rxt(290) &
                      *y(134) + rxt(296)*y(132) + rxt(304)*y(133) + rxt(317)*y(136) &
                      + rxt(322)*y(137) + rxt(326)*y(138) + rxt(339)*y(140) + rxt(346) &
                      *y(142) + rxt(352)*y(141) + rxt(364)*y(144) + rxt(370)*y(69) &
                      + rxt(376)*y(143) + rxt(380)*y(145) + rxt(387)*y(146) + rxt(395) &
                      *y(147))
         ...
         mat(1018) = mat(1018) + rxt(169)*y(129) + .190_r8*rxt(314)*y(48) &
         ...
         mat(1248) = mat(1248) + rxt(273)*y(13) + rxt(321)*y(137) + rxt(334)*y(139) &
                      + .900_r8*rxt(375)*y(143) + .900_r8*rxt(386)*y(146) + rxt(394) &
                      *y(147) + rxt(362)*y(144) + .470_r8*rxt(343)*y(142) + rxt(295) &
                      *y(132) + rxt(316)*y(136) + .250_r8*rxt(289)*y(134) &
                      + .794_r8*rxt(368)*y(69) + rxt(378)*y(145) + rxt(281)*y(131)
         mat(1285) = mat(1285) + .700_r8*rxt(390)*y(76)
         mat(1383) = mat(1383) + rxt(169)*y(1) + rxt(268)*y(17) + rxt(202)*y(8) &
         ...
         mat(1427) = mat(1427) + rxt(202)*y(129) + rxt(269)*y(16) + rxt(363)*y(144) &
                      + .470_r8*rxt(345)*y(142) + .794_r8*rxt(369)*y(69) + rxt(373) &
                      *y(70) + rxt(379)*y(145)
         mat(876) = mat(876) + rxt(273)*y(6) + 4.000_r8*rxt(275)*y(13) + rxt(218) &
                      *y(24) + .900_r8*rxt(305)*y(133) + rxt(366)*y(144) &
                      + .730_r8*rxt(347)*y(142) + rxt(353)*y(141) + rxt(297)*y(132) &
                      + rxt(318)*y(136) + .300_r8*rxt(327)*y(138) + .800_r8*rxt(381) &
                      *y(145)
         mat(59) = rxt(180)*y(129)
         mat(18) = rxt(181)*y(129)
         mat(1499) = mat(1499) + rxt(271)*y(2) + rxt(269)*y(8) + rxt(212)*y(127) &
                      + rxt(236)*y(128)
         ...
         mat(793) = mat(793) + .900_r8*rxt(305)*y(13) + rxt(367)*y(144) &
                      + .470_r8*rxt(348)*y(142) + rxt(382)*y(145)
         ...
         mat(704) = mat(704) + rxt(362)*y(6) + rxt(363)*y(8) + rxt(366)*y(13) &
                      + rxt(367)*y(133)
         mat(746) = .060_r8*rxt(336)*y(1)
         mat(643) = .275_r8*rxt(342)*y(1)
         mat(725) = mat(725) + .470_r8*rxt(343)*y(6) + .470_r8*rxt(345)*y(8) &
                      + .730_r8*rxt(347)*y(13) + .470_r8*rxt(348)*y(133)
         mat(123) = .200_r8*rxt(349)*y(129)
         mat(765) = mat(765) + rxt(353)*y(13)
         mat(466) = mat(466) + rxt(295)*y(6) + rxt(297)*y(13) + 2.400_r8*rxt(298) &
                      *y(132)
         mat(308) = rxt(392)*y(1)
         ...
         mat(577) = mat(577) + .794_r8*rxt(368)*y(6) + .794_r8*rxt(369)*y(8) &
                      + .794_r8*rxt(370)*y(130)
         mat(533) = rxt(372)*y(129) + rxt(373)*y(8)
         mat(680) = mat(680) + rxt(378)*y(6) + rxt(379)*y(8) + .800_r8*rxt(381)*y(13) &
                      + rxt(382)*y(133)
...
!----------------------------------------------
         ...
         mat(1392) = rxt(173)*y(18) + 2.000_r8*rxt(171)*y(129) + rxt(199)*y(9) &
                      + rxt(205)*y(10) + rxt(278)*y(14) + rxt(270)*y(16) + rxt(170) &
                      *y(130) + rxt(174)*y(20) + rxt(226)*y(27) + rxt(230)*y(28) &
         ...
         mat(836) = rxt(226)*y(129) + (rxt(422)+rxt(427)+rxt(433))*y(28) + (rxt(423) &
                       +rxt(434))*y(33)
         ...
         mat(1150) = -(rxt(207)*y(1) + rxt(208)*y(18) + rxt(209)*y(20) + (rxt(210) &
                      + rxt(211)) * y(130) + rxt(212)*y(16) + rxt(229)*y(28) + rxt(233) &
                      *y(29) + rxt(285)*y(38))
         ...
         mat(1046) = rxt(214)*y(2) + rxt(219)*y(6) + rxt(215)*y(129) + rxt(218)*y(13) + ( &
         ...
         mat(819) = (rxt(422)+rxt(427)+rxt(433))*y(28) + (rxt(421)+rxt(426)+rxt(432)) &
                      *y(29)
         mat(485) = (rxt(422)+rxt(427)+rxt(433))*y(27)
         mat(558) = rxt(233)*y(127) + (rxt(421)+rxt(426)+rxt(432))*y(27)

         mat(1044) = -(rxt(214)*y(2) + (rxt(215) + rxt(216)) * y(129) + rxt(217) &
                      *y(130) + rxt(218)*y(13) + rxt(219)*y(6) + rxt(220)*y(7) &
         ...
         mat(824) = -(rxt(160)*y(157) + rxt(226)*y(129) + rxt(227)*y(2) + (rxt(421) &
         ...
         mat(1141) = rxt(208)*y(18) + rxt(212)*y(16) + rxt(210)*y(130) + rxt(209) &
                      *y(20) + rxt(229)*y(28) + rxt(285)*y(38)
         mat(1037) = rxt(216)*y(129)
         mat(487) = mat(487) + rxt(229)*y(127)
         mat(86) = rxt(285)*y(127)

         mat(486) = -(rxt(228)*y(2) + rxt(229)*y(127) + rxt(230)*y(129) + (rxt(422) &
         ...
         mat(560) = -(rxt(231)*y(2) + rxt(232)*y(129) + rxt(233)*y(127) + (rxt(421) &
...
!----------------------------------------------
         ...
         mat(1230) = rxt(321)*y(137) + rxt(334)*y(139) + .400_r8*rxt(375)*y(143) &
                      + rxt(338)*y(140) + rxt(295)*y(132) + .270_r8*rxt(316)*y(136)
         ...
         mat(789) = -(rxt(302)*y(6) + rxt(303)*y(7) + rxt(304)*y(130) + rxt(305)*y(13) &
                      + 4._r8*rxt(306)*y(133) + rxt(348)*y(142) + rxt(367)*y(144) &
                      + rxt(382)*y(145))
         ...
         mat(1240) = mat(1240) + rxt(338)*y(140) + .530_r8*rxt(343)*y(142) + rxt(350) &
                      *y(141) + rxt(325)*y(138)
         mat(1373) = rxt(300)*y(41) + .500_r8*rxt(307)*y(45) + rxt(330)*y(54)
         mat(1418) = rxt(301)*y(41) + .530_r8*rxt(345)*y(142) + rxt(351)*y(141) &
                      + rxt(331)*y(54)
         mat(871) = mat(871) + .260_r8*rxt(347)*y(142) + rxt(353)*y(141) &
                      + .300_r8*rxt(327)*y(138)
         mat(608) = rxt(300)*y(129) + rxt(301)*y(8)
         mat(789) = mat(789) + .530_r8*rxt(348)*y(142)
         mat(228) = .500_r8*rxt(307)*y(129)
         mat(337) = rxt(338)*y(6)
         mat(723) = mat(723) + .530_r8*rxt(343)*y(6) + .530_r8*rxt(345)*y(8) &
                      + .260_r8*rxt(347)*y(13) + .530_r8*rxt(348)*y(133)
         mat(761) = rxt(350)*y(6) + rxt(351)*y(8) + rxt(353)*y(13) + 4.000_r8*rxt(355) &
                      *y(141)
         ...
         mat(672) = .250_r8*rxt(378)*y(6) + .250_r8*rxt(379)*y(8) + .100_r8*rxt(381) &
                      *y(13) + .250_r8*rxt(382)*y(133)
         mat(92) = .650_r8*rxt(286)*y(129)

         mat(697) = -(rxt(362)*y(6) + rxt(363)*y(8) + rxt(364)*y(130) + rxt(366)*y(13) &
                      + rxt(367)*y(133))
...
!----------------------------------------------
         ...
         mat(1238) = rxt(394)*y(147) + .320_r8*rxt(362)*y(144) + .039_r8*rxt(368) &
                      *y(69)
         ...
         mat(543) = rxt(394)*y(6)
         mat(699) = .320_r8*rxt(362)*y(6) + .350_r8*rxt(363)*y(8) + .260_r8*rxt(366) &
                      *y(13) + .350_r8*rxt(367)*y(133)
         mat(306) = rxt(392)*y(1)
         mat(576) = .039_r8*rxt(368)*y(6) + .039_r8*rxt(369)*y(8) + .039_r8*rxt(370) &
                      *y(130)
         ...
         mat(1233) = rxt(394)*y(147) + .230_r8*rxt(362)*y(144) + .167_r8*rxt(368) &
                      *y(69)
         ...
         mat(542) = rxt(394)*y(6)
         mat(694) = .230_r8*rxt(362)*y(6) + .250_r8*rxt(363)*y(8) + .190_r8*rxt(366) &
                      *y(13) + .250_r8*rxt(367)*y(133)
         mat(305) = rxt(392)*y(1)
         mat(574) = .167_r8*rxt(368)*y(6) + .167_r8*rxt(369)*y(8) + .167_r8*rxt(370) &
                      *y(130)

         mat(721) = -((rxt(343) + rxt(344)) * y(6) + rxt(345)*y(8) + rxt(346)*y(130) &
                      + rxt(347)*y(13) + rxt(348)*y(133))
         ...
         mat(760) = -(rxt(350)*y(6) + rxt(351)*y(8) + rxt(352)*y(130) + rxt(353)*y(13) &
                      + rxt(354)*y(133) + 4._r8*rxt(355)*y(141) + rxt(356)*y(7))
         ...
         mat(462) = -(rxt(295)*y(6) + rxt(296)*y(130) + rxt(297)*y(13) + 4._r8*rxt(298) &
                      *y(132))
         ...
         mat(1215) = .500_r8*rxt(334)*y(139) + .250_r8*rxt(375)*y(143) &
                      + .100_r8*rxt(394)*y(147) + .820_r8*rxt(316)*y(136)
         ...
         mat(853) = 2.000_r8*rxt(276)*y(13) + .250_r8*rxt(366)*y(144) &
                      + .250_r8*rxt(347)*y(142) + .300_r8*rxt(297)*y(132) &
                      + .500_r8*rxt(327)*y(138) + .300_r8*rxt(381)*y(145)
         ...
         mat(715) = .530_r8*rxt(343)*y(6) + .530_r8*rxt(345)*y(8) + .260_r8*rxt(347) &
                      *y(13) + .530_r8*rxt(348)*y(133)
         mat(190) = rxt(291)*y(3)
         mat(673) = .250_r8*rxt(378)*y(6) + .250_r8*rxt(379)*y(8) + .100_r8*rxt(381) &
                      *y(13) + .250_r8*rxt(382)*y(133)
         ...
         mat(862) = .230_r8*rxt(347)*y(142) + .200_r8*rxt(327)*y(138) &
                      + .100_r8*rxt(381)*y(145)
         mat(263) = .500_r8*rxt(323)*y(129)
         mat(781) = .220_r8*rxt(348)*y(142) + .250_r8*rxt(382)*y(145)
         mat(289) = .500_r8*rxt(358)*y(129)
         mat(718) = .220_r8*rxt(343)*y(6) + .220_r8*rxt(345)*y(8) + .230_r8*rxt(347) &
                      *y(13) + .220_r8*rxt(348)*y(133)
         mat(624) = .200_r8*rxt(327)*y(13)
         mat(675) = .250_r8*rxt(378)*y(6) + .250_r8*rxt(379)*y(8) + .100_r8*rxt(381) &
                      *y(13) + .250_r8*rxt(382)*y(133)
         ...
         mat(689) = .370_r8*rxt(362)*y(6) + .400_r8*rxt(363)*y(8) + .300_r8*rxt(366) &
                      *y(13) + .400_r8*rxt(367)*y(133)
         ...
         mat(1234) = .450_r8*rxt(386)*y(146) + .250_r8*rxt(343)*y(142) &
                      + .250_r8*rxt(378)*y(145)
         mat(1367) = mat(1367) + rxt(332)*y(64) + rxt(329)*y(53)
         mat(1412) = mat(1412) + .250_r8*rxt(345)*y(142) + .250_r8*rxt(379)*y(145)
         mat(865) = .240_r8*rxt(347)*y(142) + .500_r8*rxt(327)*y(138) &
                      + .100_r8*rxt(381)*y(145)
         ...
         mat(719) = .250_r8*rxt(343)*y(6) + .250_r8*rxt(345)*y(8) + .240_r8*rxt(347) &
                      *y(13) + .250_r8*rxt(348)*y(133)
         mat(617) = rxt(329)*y(129)
         mat(626) = .500_r8*rxt(327)*y(13)
         mat(676) = .250_r8*rxt(378)*y(6) + .250_r8*rxt(379)*y(8) + .100_r8*rxt(381) &
                      *y(13) + .250_r8*rxt(382)*y(133)
...
!----------------------------------------------
         ...
         mat(1226) = .080_r8*rxt(362)*y(144) + .800_r8*rxt(344)*y(142) &
                      + .794_r8*rxt(368)*y(69)
         mat(1402) = mat(1402) + .794_r8*rxt(369)*y(69)
         mat(1090) = .794_r8*rxt(370)*y(69)
         mat(692) = .080_r8*rxt(362)*y(6)
         mat(716) = .800_r8*rxt(344)*y(6)
         mat(571) = .794_r8*rxt(368)*y(6) + .794_r8*rxt(369)*y(8) + .794_r8*rxt(370) &
                      *y(130)

         mat(677) = -(rxt(378)*y(6) + rxt(379)*y(8) + rxt(380)*y(130) + rxt(381)*y(13) &
                      + rxt(382)*y(133))
         ...
         mat(1357) = mat(1357) + (rxt(415)+.500_r8*rxt(416))*y(105) + rxt(402)*y(106) &
                      + rxt(406)*y(108)
         ...
         mat(804) = rxt(408)*y(1) + rxt(407)*y(3) + rxt(409)*y(7) + rxt(406)*y(129) &
         ...
         mat(805) = -(rxt(406)*y(129) + rxt(407)*y(3) + rxt(408)*y(1) + rxt(409)*y(7) &
