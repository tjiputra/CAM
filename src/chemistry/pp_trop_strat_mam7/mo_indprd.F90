...
!--------------------------------------------------------------------
         ...
         prod(:,:,133) =.180_r8*rxt(:,:,55)*y(:,:,12) +rxt(:,:,53)*y(:,:,117) &
                  +2.000_r8*rxt(:,:,1)

         prod(:,:,132) =rxt(:,:,4)*y(:,:,4)

         prod(:,:,107) =1.440_r8*rxt(:,:,55)*y(:,:,12)

         prod(:,:,108) =.380_r8*rxt(:,:,55)*y(:,:,12) +rxt(:,:,53)*y(:,:,117) &
                  + extfrc(:,:,3)
         ...
         prod(:,:,122) =rxt(:,:,54)*y(:,:,12) +rxt(:,:,35)*y(:,:,99) +rxt(:,:,46) &
                 *y(:,:,100)
         ...
         prod(:,:,124) =.180_r8*rxt(:,:,55)*y(:,:,12)

         prod(:,:,121) =rxt(:,:,54)*y(:,:,12)

         prod(:,:,129) = 0._r8

         prod(:,:,86) = 0._r8

         prod(:,:,120) =.050_r8*rxt(:,:,55)*y(:,:,12)

         prod(:,:,125) =rxt(:,:,35)*y(:,:,99) +3.000_r8*rxt(:,:,38)*y(:,:,101) &
         ...
         prod(:,:,123) =rxt(:,:,46)*y(:,:,100) +rxt(:,:,47)*y(:,:,107) +rxt(:,:,50) &
