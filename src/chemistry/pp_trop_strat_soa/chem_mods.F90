...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 84, & ! number of photolysis reactions
                            rxntot = 409, & ! number of total reactions
                            gascnt = 325, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 170, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1277, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 133, & ! number of species in implicit class
