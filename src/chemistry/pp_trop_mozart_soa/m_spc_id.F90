      ...
      integer, parameter :: id_OCS = 100
      integer, parameter :: id_SO2 = 101
      integer, parameter :: id_DMS = 102
      integer, parameter :: id_SO4 = 103
      integer, parameter :: id_NH3 = 104
      integer, parameter :: id_NH4 = 105
      integer, parameter :: id_NH4NO3 = 106
      integer, parameter :: id_SSLT01 = 107
      integer, parameter :: id_SSLT02 = 108
      integer, parameter :: id_SSLT03 = 109
      integer, parameter :: id_SSLT04 = 110
      integer, parameter :: id_DST01 = 111
      integer, parameter :: id_DST02 = 112
      integer, parameter :: id_DST03 = 113
      integer, parameter :: id_DST04 = 114
      integer, parameter :: id_Rn = 115
      integer, parameter :: id_Pb = 116
      integer, parameter :: id_HCN = 117
      integer, parameter :: id_CH3CN = 118
      integer, parameter :: id_C2H2 = 119
      integer, parameter :: id_HCOOH = 120
      integer, parameter :: id_HOCH2OO = 121
      integer, parameter :: id_NH_5 = 122
      integer, parameter :: id_NH_50 = 123
      integer, parameter :: id_NH_50W = 124
      integer, parameter :: id_AOA_NH = 125
      integer, parameter :: id_ST80_25 = 126
      integer, parameter :: id_CO_25 = 127
      integer, parameter :: id_CO_50 = 128
      integer, parameter :: id_SO2t = 129
      integer, parameter :: id_SF6 = 130
      integer, parameter :: id_SF6em = 131
      end module m_spc_id
