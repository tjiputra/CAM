...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 45, & ! number of photolysis reactions
                            ...
                            gas_pcnst = 131, & ! number of "gas phase" species
                            nfs = 4, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 987, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 127, & ! number of species in implicit class
