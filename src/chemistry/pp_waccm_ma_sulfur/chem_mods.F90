...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: phtcnt = 79, & ! number of photolysis reactions
                            rxntot = 254, & ! number of total reactions
                            gascnt = 175, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 66, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 588, & ! number of non-zero matrix entries
                            extcnt = 12, & ! number of species with external forcing
