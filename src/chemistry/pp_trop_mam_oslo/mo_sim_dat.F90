...
!--------------------------------------------------------------
      ...
      solsym(: 31) = (/ 'SO2             ','H2SO4           ','DMS             ','H2O2            ','SO4_NA          ', &
                        ...
                        'SOA_LV          ','SOA_SV          ','monoterp        ','isoprene        ','CHBR3           ', &
                        'H2O             ' /)
      ...
      adv_mass(: 31) = (/    64.064800_r8,    98.078400_r8,    62.132400_r8,    34.013600_r8,    98.078400_r8, &
                            ...
                            168.227200_r8,   168.227200_r8,   136.228400_r8,    68.114200_r8,   252.730400_r8, &
                             18.014200_r8 /)
      ...
      crb_mass(: 31) = (/     0.000000_r8,     0.000000_r8,    24.022000_r8,     0.000000_r8,     0.000000_r8, &
                            ...
                            120.110000_r8,   120.110000_r8,   120.110000_r8,    60.055000_r8,    12.011000_r8, &
                              0.000000_r8 /)
      ...
      diag_map(: 31) = (/    1,   5,   7,   9,  10,  11,  12,  13,  14,  15, &
