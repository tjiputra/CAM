...
!--------------------------------------------------------------------
      ...
      rate(:,:,157) = rate(:,:,157) * inv(:,:, 2)
      rate(:,:,161) = rate(:,:,161) * inv(:,:, 2)
      rate(:,:,165) = rate(:,:,165) * inv(:,:, 2)
      rate(:,:,170) = rate(:,:,170) * inv(:,:, 1)
      rate(:,:,171) = rate(:,:,171) * inv(:,:, 1)
      rate(:,:,177) = rate(:,:,177) * inv(:,:, 1)
      rate(:,:,187) = rate(:,:,187) * inv(:,:, 1)
      rate(:,:,199) = rate(:,:,199) * inv(:,:, 1)
      rate(:,:,207) = rate(:,:,207) * inv(:,:, 1)
      ...
      rate(:,:,250) = rate(:,:,250) * inv(:,:, 1)
      rate(:,:,251) = rate(:,:,251) * inv(:,:, 1)
      rate(:,:,261) = rate(:,:,261) * inv(:,:, 1)
      rate(:,:,307) = rate(:,:,307) * inv(:,:, 1)
      rate(:,:,308) = rate(:,:,308) * inv(:,:, 1)
      rate(:,:,318) = rate(:,:,318) * inv(:,:, 1)
      ...
      rate(:,:,467) = rate(:,:,467) * inv(:,:, 1)
      rate(:,:,472) = rate(:,:,472) * inv(:,:, 1)
      rate(:,:,577) = rate(:,:,577) * inv(:,:, 2)
      rate(:,:,580) = rate(:,:,580) * inv(:,:, 2)
      rate(:,:,155) = rate(:,:,155) * m(:,:)
      rate(:,:,156) = rate(:,:,156) * m(:,:)
      rate(:,:,158) = rate(:,:,158) * m(:,:)
      rate(:,:,159) = rate(:,:,159) * m(:,:)
