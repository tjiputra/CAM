...
!--------------------------------------------------------------------
      ...
      rate(:,:,155) = rate(:,:,155) * inv(:,:, 1)
      rate(:,:,158) = rate(:,:,158) * inv(:,:, 2)
      rate(:,:,164) = rate(:,:,164) * inv(:,:, 2)
      rate(:,:,167) = rate(:,:,167) * inv(:,:, 2)
      ...
      rate(:,:,327) = rate(:,:,327) * inv(:,:, 1)
      rate(:,:,328) = rate(:,:,328) * inv(:,:, 1)
      rate(:,:,330) = rate(:,:,330) * inv(:,:, 1)
      rate(:,:,332) = rate(:,:,332) * inv(:,:, 1)
      rate(:,:,347) = rate(:,:,347) * inv(:,:, 1)
      rate(:,:,355) = rate(:,:,355) * inv(:,:, 1)
      rate(:,:,358) = rate(:,:,358) * inv(:,:, 1)
      rate(:,:,404) = rate(:,:,404) * inv(:,:, 1)
      ...
      rate(:,:,566) = rate(:,:,566) * inv(:,:, 2)
      rate(:,:,576) = rate(:,:,576) * inv(:,:, 2)
      rate(:,:,153) = rate(:,:,153) * m(:,:)
      rate(:,:,154) = rate(:,:,154) * m(:,:)
      rate(:,:,155) = rate(:,:,155) * m(:,:)
      rate(:,:,156) = rate(:,:,156) * m(:,:)
