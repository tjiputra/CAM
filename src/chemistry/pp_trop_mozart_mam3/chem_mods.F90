...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 43, & ! number of photolysis reactions
                            rxntot = 232, & ! number of total reactions
                            gascnt = 189, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 109, & ! number of "gas phase" species
                            nfs = 4, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 936, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 105, & ! number of species in implicit class
