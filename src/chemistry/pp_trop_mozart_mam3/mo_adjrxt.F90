...
!--------------------------------------------------------------------
      ...
      rate(:,:, 46) = rate(:,:, 46) * inv(:,:, 2)
      rate(:,:, 47) = rate(:,:, 47) * inv(:,:, 3)
      rate(:,:, 49) = rate(:,:, 49) * inv(:,:, 4)
      rate(:,:, 66) = rate(:,:, 66) * inv(:,:, 1)
      rate(:,:, 74) = rate(:,:, 74) * inv(:,:, 1)
      ...
      rate(:,:,110) = rate(:,:,110) * inv(:,:, 1)
      rate(:,:,112) = rate(:,:,112) * inv(:,:, 1)
      rate(:,:,115) = rate(:,:,115) * inv(:,:, 3)
