...
!--------------------------------------------------------------------
      ...
      rate(:,:,138) = rate(:,:,138) * inv(:,:, 2)
      rate(:,:,139) = rate(:,:,139) * inv(:,:, 3)
      rate(:,:,176) = rate(:,:,176) * inv(:,:, 1)
      rate(:,:,184) = rate(:,:,184) * inv(:,:, 1)
      rate(:,:,186) = rate(:,:,186) * inv(:,:, 3)
      ...
      rate(:,:,285) = rate(:,:,285) * inv(:,:, 1)
      rate(:,:,288) = rate(:,:,288) * inv(:,:, 3)
      ...
      rate(:,:,423) = rate(:,:,423) * inv(:,:, 1)
      rate(:,:,433) = rate(:,:,433) * inv(:,:, 1)
      rate(:,:,434) = rate(:,:,434) * inv(:,:, 1)
      rate(:,:,135) = rate(:,:,135) * inv(:,:, 3) * inv(:,:, 1)
      rate(:,:,167) = rate(:,:,167) * inv(:,:, 3) * inv(:,:, 1)
      rate(:,:,136) = rate(:,:,136) * m(:,:)
      rate(:,:,137) = rate(:,:,137) * m(:,:)
      rate(:,:,140) = rate(:,:,140) * m(:,:)
      rate(:,:,141) = rate(:,:,141) * m(:,:)
