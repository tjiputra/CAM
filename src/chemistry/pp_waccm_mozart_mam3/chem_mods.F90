...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 91, & ! number of photolysis reactions
                            ...
                            gas_pcnst = 94, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 731, & ! number of non-zero matrix entries
                            extcnt = 19, & ! number of species with external forcing
                            clscnt1 = 23, & ! number of species in explicit class
                            clscnt2 = 0, & ! number of species in hov class
                            clscnt3 = 0, & ! number of species in ebi class
                            clscnt4 = 71, & ! number of species in implicit class
