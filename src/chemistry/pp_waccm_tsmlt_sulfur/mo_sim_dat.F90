...
!--------------------------------------------------------------
      ...
      rxt_tag_lst(:rxt_tag_cnt) = (/ 'jo2_a           ', 'jo2_b           ', 'jo3_a           ', 'jo3_b           ', &
                                     ...
                                     'CRESOL_OH       ', 'XOH_NO2         ', 'BENZENE_OH      ', 'BENO2_HO2       ', &
                                     'BENO2_NO        ', 'XYLENE_OH       ', 'XYLO2_HO2       ', 'XYLO2_NO        ', &
                                     'C10H16_OH       ', 'C10H16_O3       ', 'C10H16_NO3      ', 'TERPO2_NO       ', &
                                     'TERPO2_HO2      ', 'TERPOOH_OH      ', 'usr_N2O5_aer    ', 'usr_NO3_aer     ', &
                                     'usr_NO2_aer     ', 'CB1_CB2         ', 'OC1_OC2         ', 'usr_HO2_aer     ', &
                                     'usr_CB1_strat_ta', 'usr_CB2_strat_ta', 'usr_OC1_strat_ta', 'usr_OC2_strat_ta', &
                                     'usr_SO4_strat_ta', 'usr_SOAM_strat_t', 'usr_SOAI_strat_t', 'usr_SOAB_strat_t', &
                                     'usr_SOAT_strat_t', 'usr_SOAX_strat_t', 'usr_NH4_strat_ta', 'usr_NH4NO3_strat', &
                                     'usr_SSLT01_strat', 'usr_SSLT02_strat', 'usr_SSLT03_strat', 'usr_SSLT04_strat', &
                                     'usr_DST01_strat_', 'usr_DST02_strat_', 'usr_DST03_strat_', 'usr_DST04_strat_', &
