...
!--------------------------------------------------------------------
      real(r8) :: im(ncol,pver)
         ...
         rate(:,:,110) = rate(:,:,110) * inv(:,:, 2)
         rate(:,:,116) = rate(:,:,116) * inv(:,:, 2)
         rate(:,:,118) = rate(:,:,118) * inv(:,:, 2)
         rate(:,:,149) = rate(:,:,149) * inv(:,:, 1)
         rate(:,:,158) = rate(:,:,158) * inv(:,:, 1)
         rate(:,:,166) = rate(:,:,166) * inv(:,:, 1)
         rate(:,:,176) = rate(:,:,176) * inv(:,:, 1)
         rate(:,:,180) = rate(:,:,180) * inv(:,:, 1)
         rate(:,:,182) = rate(:,:,182) * inv(:,:, 1)
         rate(:,:,183) = rate(:,:,183) * inv(:,:, 1)
         ...
         rate(:,:,463) = rate(:,:,463) * inv(:,:, 1)
         rate(:,:,465) = rate(:,:,465) * inv(:,:, 1)
         rate(:,:,580) = rate(:,:,580) * inv(:,:, 1)
         rate(:,:,581) = rate(:,:,581) * inv(:,:, 1)
         rate(:,:,582) = rate(:,:,582) * inv(:,:, 1)
         rate(:,:,583) = rate(:,:,583) * inv(:,:, 1)
         rate(:,:,584) = rate(:,:,584) * inv(:,:, 1)
         rate(:,:,585) = rate(:,:,585) * inv(:,:, 1)
         rate(:,:,586) = rate(:,:,586) * inv(:,:, 1)
         rate(:,:,587) = rate(:,:,587) * inv(:,:, 1)
         rate(:,:,588) = rate(:,:,588) * inv(:,:, 1)
         rate(:,:,589) = rate(:,:,589) * inv(:,:, 1)
         rate(:,:,590) = rate(:,:,590) * inv(:,:, 1)
         rate(:,:,591) = rate(:,:,591) * inv(:,:, 1)
         rate(:,:,592) = rate(:,:,592) * inv(:,:, 1)
         rate(:,:,593) = rate(:,:,593) * inv(:,:, 1)
         rate(:,:,362) = rate(:,:,362) * inv(:,:, 2) * inv(:,:, 1)
         rate(:,:,105) = rate(:,:,105) * m(:,:)
         rate(:,:,106) = rate(:,:,106) * m(:,:)
         rate(:,:,107) = rate(:,:,107) * m(:,:)
         rate(:,:,108) = rate(:,:,108) * m(:,:)
