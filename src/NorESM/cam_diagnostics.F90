...
! dry mass for  each mode/mixture (for calculation of specific extinction without condensed water):
   call addfld ('CMDRY0 ','unitless',1,    'A','Total dry mass load for kcomp 0',phys_decomp)
   call addfld ('CMDRY1 ','unitless',1,    'A','Total dry mass load for kcomp 1',phys_decomp)
   call addfld ('CMDRY2 ','unitless',1,    'A','Total dry mass load for kcomp 2',phys_decomp)
   call addfld ('CMDRY4 ','unitless',1,    'A','Total dry mass load for kcomp 4',phys_decomp)
   call addfld ('CMDRY5 ','unitless',1,    'A','Total dry mass load for kcomp 5',phys_decomp)
   call addfld ('CMDRY6 ','unitless',1,    'A','Total dry mass load for kcomp 6',phys_decomp)
   call addfld ('CMDRY7 ','unitless',1,    'A','Total dry mass load for kcomp 7',phys_decomp)
   call addfld ('CMDRY8 ','unitless',1,    'A','Total dry mass load for kcomp 8',phys_decomp)
   call addfld ('CMDRY9 ','unitless',1,    'A','Total dry mass load for kcomp 9',phys_decomp)
   call addfld ('CMDRY10','unitless',1,    'A','Total dry mass load for kcomp 10',phys_decomp)
   call addfld ('CMDRY12','unitless',1,    'A','Total dry mass load for kcomp 12',phys_decomp)
   call addfld ('CMDRY14','unitless',1,    'A','Total dry mass load for kcomp 14',phys_decomp)
#endif
#endif
#endif  ! aeroffl
#ifdef AEROCOM 
...
<<<<<<< HEAD:components/cam/src/NorESM/cam_diagnostics.F90
=======
...
>>>>>>> publicOsloDev:models/atm/cam/src/NorESM/cam_diagnostics.F90
