...
! !USES:
    ...
    use constituents,  only: cnst_get_type_byind, qmin !+tht (dlw/jgo) added qmin
...
!+tht (dlw/jgo)
!
! Make sure that input water tracers are all positive
!
       m = 1
       call qneg3('D_P_COUPLING/Q'     ,lchnk  ,ncol    ,pcols   ,pver    , &
